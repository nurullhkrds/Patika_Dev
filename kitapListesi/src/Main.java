...
public class Main {
    public static void main(String[] args) {
        ...
        List<Book> books100 = books.stream().filter(book -> book.getNumberPage() > 100).toList();
        System.out.println("Sayfa sayısı 100'den fazla kitap listesi: ");
        books100.forEach(book -> System.out.println("Book Name: " + book.getName() + ", Page Count: " + book.getNumberPage()));
